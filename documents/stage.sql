...
-- Export de la structure de la base pour stage
CREATE DATABASE IF NOT EXISTS `stage` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `stage`;

-- Export de la structure de la table stage. eleve
CREATE TABLE IF NOT EXISTS `eleve` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom_eleve` longtext COLLATE utf8_unicode_ci NOT NULL,
  `prenom_eleve` longtext COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Export de données de la table stage.eleve : ~2 rows (environ)
/*!40000 ALTER TABLE `eleve` DISABLE KEYS */;
INSERT INTO `eleve` (`id`, `nom_eleve`, `prenom_eleve`) VALUES
	(1, 'Cottencin', 'Angélique'),
	(2, 'Torres Païva', 'Raphaël');
/*!40000 ALTER TABLE `eleve` ENABLE KEYS */;

-- Export de la structure de la table stage. entreprise
CREATE TABLE IF NOT EXISTS `entreprise` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom_entreprise` longtext COLLATE utf8_unicode_ci,
  `ville_entreprise` longtext COLLATE utf8_unicode_ci,
  `cp_entreprise` int(11) DEFAULT NULL,
  `adresse_entreprise` longtext COLLATE utf8_unicode_ci,
  `mail_entreprise` longtext COLLATE utf8_unicode_ci,
  `tel_entreprise` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `activite_entreprise` longtext COLLATE utf8_unicode_ci,
  `active` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Export de données de la table stage.entreprise : ~115 rows (environ)
/*!40000 ALTER TABLE `entreprise` DISABLE KEYS */;
INSERT INTO `entreprise` (`id`, `nom_entreprise`, `ville_entreprise`, `cp_entreprise`, `adresse_entreprise`, `mail_entreprise`, `tel_entreprise`, `activite_entreprise`, `active`) VALUES
...
-- Export de la structure de la table stage. migration_versions
CREATE TABLE IF NOT EXISTS `migration_versions` (
  `version` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`version`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Export de données de la table stage.migration_versions : ~11 rows (environ)
...
-- Export de la structure de la table stage. stage
CREATE TABLE IF NOT EXISTS `stage` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_C27C936922444C7` (`id_eleve`),
  KEY `IDX_C27C936970769785` (`id_tuteur`),
  CONSTRAINT `FK_C27C936922444C7` FOREIGN KEY (`id_eleve`) REFERENCES `eleve` (`id`),
  CONSTRAINT `FK_C27C936970769785` FOREIGN KEY (`id_tuteur`) REFERENCES `tuteur` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Export de données de la table stage.stage : ~1 rows (environ)
/*!40000 ALTER TABLE `stage` DISABLE KEYS */;
INSERT INTO `stage` (`id`, `id_eleve`, `id_tuteur`, `date_ajout`) VALUES
	(3, 1, 1, '30-03-2018');
/*!40000 ALTER TABLE `stage` ENABLE KEYS */;

-- Export de la structure de la table stage. tuteur
CREATE TABLE IF NOT EXISTS `tuteur` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom_tuteur` longtext COLLATE utf8_unicode_ci NOT NULL,
  `prenom_tuteur` longtext COLLATE utf8_unicode_ci NOT NULL,
  `mail_tuteur` longtext COLLATE utf8_unicode_ci NOT NULL,
  `tel_tuteur` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `id_entreprise` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_56412268A8937AB7` (`id_entreprise`),
  CONSTRAINT `FK_56412268A8937AB7` FOREIGN KEY (`id_entreprise`) REFERENCES `entreprise` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Export de données de la table stage.tuteur : ~6 rows (environ)
/*!40000 ALTER TABLE `tuteur` DISABLE KEYS */;
INSERT INTO `tuteur` (`id`, `nom_tuteur`, `prenom_tuteur`, `mail_tuteur`, `tel_tuteur`, `id_entreprise`) VALUES
	(1, 'toto', 'tot', 'truc@gmail.com', '0630817856', 2),
	(2, 'toto', 'toto', 'truc@gmail.com', '0630817856', 5),
	(3, 'toto', 'toto', 'truc@gmail.com', '0630817856', 5),
	(4, 'Angélique', 'Cottencin', 'angec169@gmail.com', '0102030405', 18),
	(5, 'Torres Païva', 'Raphaël', 'paiva.raphaelt@gmail.com', '0102030405', 9),
	(6, 'Raphaella', 'Raphaella', 'raphallou@live.fr', '0102031415', 31);
